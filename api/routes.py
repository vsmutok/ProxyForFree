...
async def stop_proxy(request: StopProxyRequest):
    """
...
async def list_configs(country: str | None = Query(None, description="Filter by country name")):
    """
